...
| [celebrity_distances.txt](./metrics/celebrity_distances.txt) | Results file containing distance metrics from face recognition experiments without thresholding, for Celebrity Faces Dataset. |
